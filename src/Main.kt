fun main() {
    ...
    model.gameBoard[0][0] = Player.O
    model.gameBoard[1][0] = Player.O
    model.gameBoard[2][0] = Player.X

    model.gameBoard[0][1] = Player.X
    model.gameBoard[1][1] = Player.O
    model.gameBoard[2][1] = Player.X
    ...
    println(model.doesUserWinVertically())
    println(model.doesUserWinHorizontally())
    // X X X
    // X O X
    // O X x
    //
